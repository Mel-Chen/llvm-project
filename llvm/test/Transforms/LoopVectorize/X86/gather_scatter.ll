...
; AVX512-NEXT:    [[TMP12:%.*]] = mul i64 [[N_VEC]], 4
; AVX512-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[PTR]], i64 [[TMP12]]
; AVX512-NEXT:    br label [[VECTOR_BODY:%.*]]
; AVX512:       vector.body:
...
; AVX512-NEXT:    [[TMP22:%.*]] = mul i64 [[N_VEC10]], 4
; AVX512-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr [[PTR]], i64 [[TMP22]]
...
; FVW2-NEXT:    [[TMP12:%.*]] = mul i64 [[N_VEC]], 4
; FVW2-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[PTR]], i64 [[TMP12]]
; FVW2-NEXT:    br label [[VECTOR_BODY:%.*]]
; FVW2:       vector.body:
