...
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq i64 [[INDEX_NEXT]], 12
...
; CHECK:       loop.header:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ 87, [[BB6]] ], [ [[IV_NEXT:%.*]], [[LOOP_LATCH:%.*]] ]
...
; CHECK-NEXT:    br i1 [[ICMP22]], label [[BB7:%.*]], label [[LOOP_HEADER]], !prof [[PROF6:![0-9]+]], !llvm.loop [[LOOP7:![0-9]+]]
; CHECK:       bb6:
; CHECK-NEXT:    ret void
;
bb5:
