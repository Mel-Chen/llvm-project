...
; IC4VF4-NEXT:  [[PRED_LOAD_IF41:.*]]:
; IC4VF4-NEXT:    br label %[[PRED_LOAD_CONTINUE42:.*]]
; IC4VF4:       [[PRED_LOAD_CONTINUE42]]:
; IC4VF4-NEXT:    [[IV:%.*]] = phi i16 [ 12, %[[PRED_LOAD_IF41]] ], [ [[IV_NEXT:%.*]], %[[PRED_LOAD_CONTINUE42]] ]
; IC4VF4-NEXT:    [[RDX:%.*]] = phi i16 [ 0, %[[PRED_LOAD_IF41]] ], [ [[SPEC_SELECT:%.*]], %[[PRED_LOAD_CONTINUE42]] ]
; IC4VF4-NEXT:    [[TMP96:%.*]] = getelementptr inbounds [13 x i16], ptr @table, i16 0, i16 [[IV]]
; IC4VF4-NEXT:    [[TMP97:%.*]] = load i16, ptr [[TMP96]], align 1
; IC4VF4-NEXT:    [[CMP_TABLE_VAL:%.*]] = icmp ugt i16 [[TMP97]], [[VAL]]
...
; IC4VF4-NEXT:    br i1 [[EXIT_COND]], label %[[EXIT:.*]], label %[[PRED_LOAD_CONTINUE42]]
; IC4VF4:       [[EXIT]]:
; IC4VF4-NEXT:    [[RDX_SELECT:%.*]] = phi i16 [ [[SPEC_SELECT]], %[[PRED_LOAD_CONTINUE42]] ]
...
; IC4VF4-NEXT:    [[CMP_TABLE_VAL:%.*]] = fcmp ugt half [[TMP97]], [[VAL]]
; IC4VF4-NEXT:    [[IV_NEXT]] = add nsw i16 [[IV]], -1
; IC4VF4-NEXT:    [[SPEC_SELECT]] = select i1 [[CMP_TABLE_VAL]], i16 [[IV_NEXT]], i16 [[RDX]]
; IC4VF4-NEXT:    [[EXIT_COND:%.*]] = icmp eq i16 [[IV_NEXT]], 0
; IC4VF4-NEXT:    br i1 [[EXIT_COND]], label %[[EXIT:.*]], label %[[PRED_LOAD_CONTINUE42]]
