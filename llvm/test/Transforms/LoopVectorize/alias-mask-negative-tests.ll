...
; CHECK-NEXT:    [[LAST_ACTIVE_LANE1:%.*]] = sub i64 [[FIRST_INACTIVE_LANE1]], 1
; CHECK-NEXT:    [[VECTOR_RECUR_INIT:%.*]] = insertelement <4 x i32> poison, i32 [[INIT_VAL]], i64 [[LAST_ACTIVE_LANE1]]
