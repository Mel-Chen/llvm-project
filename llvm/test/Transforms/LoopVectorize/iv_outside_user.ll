...
; VEC-NEXT:    [[TMP7:%.*]] = trunc i64 [[N_VEC]] to i32
...
; VEC:       [[SCALAR_PH]]:
; VEC-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i32 [ [[TMP7]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
...
; INTERLEAVE-NEXT:    [[TMP5:%.*]] = trunc i64 [[N_VEC]] to i32
...
; INTERLEAVE-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i32 [ [[TMP5]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
