...
; CHECK:       cond.end:
; CHECK-NEXT:    [[COND:%.*]] = phi i64 [ [[DIV]], [[COND_FALSE]] ], [ 77, [[MIDDLE_BLOCK]] ]
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[I]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], 3
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP:%.*]], label [[MIDDLE_BLOCK]]
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    [[TMP5:%.*]] = phi i64 [ [[COND]], [[COND_END]] ]
...
; CHECK-NEXT:    br i1 [[TMP1]], label [[COND_END]], label [[COND_FALSE:%.*]]
; CHECK:       cond.false:
; CHECK-NEXT:    br label [[COND_END]]
; CHECK:       cond.end:
; CHECK-NEXT:    [[COND:%.*]] = phi i64 [ 55, [[COND_FALSE]] ], [ 77, [[VECTOR_PH]] ]
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[I]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], 3
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP:%.*]], label [[VECTOR_PH]]
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    [[TMP4:%.*]] = phi i64 [ [[COND]], [[COND_END]] ]
...
; CHECK-NEXT:    br label [[COND_END]]
; CHECK:       cond.end:
; CHECK-NEXT:    [[COND:%.*]] = phi i32 [ 55, [[COND_FALSE]] ], [ [[I]], [[VECTOR_PH]] ]
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[I]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], 3
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP:%.*]], label [[VECTOR_PH]]
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    [[TMP4:%.*]] = phi i32 [ [[COND]], [[COND_END]] ]
