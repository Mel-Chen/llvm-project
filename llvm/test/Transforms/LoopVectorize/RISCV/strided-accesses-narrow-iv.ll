...
; RV64-NEXT:    [[TMP2:%.*]] = shl i64 [[TMP1]], 12
; RV64-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[ARR]], i64 [[TMP2]]
; RV64-NEXT:    [[TMP3:%.*]] = call <vscale x 8 x i8> @llvm.experimental.vp.strided.load.nxv8i8.p0.i64(ptr align 1 [[TMP5]], i64 4096, <vscale x 8 x i1> splat (i1 true), i32 [[TMP0]])
