...
; CHECK-NEXT:    [[TMP10:%.*]] = shl i64 [[TMP9]], 5
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr [[B]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP11:%.*]] = call <vscale x 2 x double> @llvm.experimental.vp.strided.load.nxv2f64.p0.i64(ptr align 8 [[TMP16]], i64 32, <vscale x 2 x i1> splat (i1 true), i32 [[TMP7]])
