...
; CHECK-NEXT:    [[TMP7:%.*]] = shl nuw nsw i64 [[INDEX]], 3
...
; CHECK-UF2-NEXT:    [[TMP18:%.*]] = getelementptr i32, ptr [[P]], i64 [[TMP8]]
...
; CHECK-UF2-NEXT:    [[TMP19:%.*]] = shl i64 [[TMP3]], 3
; CHECK-UF2-NEXT:    [[TMP20:%.*]] = getelementptr i32, ptr [[TMP18]], i64 [[TMP19]]
; CHECK-UF2-NEXT:    [[TMP16:%.*]] = trunc i64 [[TMP3]] to i32
; CHECK-UF2-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP18]], i64 32, <vscale x 4 x i1> splat (i1 true), i32 [[TMP16]])
; CHECK-UF2-NEXT:    [[TMP17:%.*]] = trunc i64 [[TMP3]] to i32
; CHECK-UF2-NEXT:    [[WIDE_MASKED_GATHER1:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP20]], i64 32, <vscale x 4 x i1> splat (i1 true), i32 [[TMP17]])
...
; CHECK-UF2-NEXT:    [[TMP16:%.*]] = getelementptr i32, ptr [[P]], i64 [[OFFSET_IDX]]
...
; CHECK-UF2-NEXT:    [[TMP17:%.*]] = shl i64 [[TMP3]], 6
; CHECK-UF2-NEXT:    [[TMP18:%.*]] = getelementptr i32, ptr [[TMP16]], i64 [[TMP17]]
; CHECK-UF2-NEXT:    [[TMP14:%.*]] = trunc i64 [[TMP3]] to i32
; CHECK-UF2-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP16]], i64 256, <vscale x 4 x i1> splat (i1 true), i32 [[TMP14]])
; CHECK-UF2-NEXT:    [[TMP15:%.*]] = trunc i64 [[TMP3]] to i32
; CHECK-UF2-NEXT:    [[WIDE_MASKED_GATHER1:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP18]], i64 256, <vscale x 4 x i1> splat (i1 true), i32 [[TMP15]])
...
; STRIDED-NEXT:    [[TMP46:%.*]] = shl i64 [[STRIDE]], 2
...
; STRIDED:       [[VECTOR_BODY]]:
; STRIDED-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[CURRENT_ITERATION_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; STRIDED-NEXT:    [[TMP47:%.*]] = call <vscale x 4 x i32> @llvm.stepvector.nxv4i32()
; STRIDED-NEXT:    [[TMP48:%.*]] = icmp ult <vscale x 4 x i32> [[TMP47]], [[BROADCAST_SPLAT12]]
; STRIDED-NEXT:    [[TMP49:%.*]] = mul nuw nsw i64 [[INDEX]], [[STRIDE]]
; STRIDED-NEXT:    [[TMP18:%.*]] = mul nuw nsw <vscale x 4 x i64> [[VEC_IND]], [[BROADCAST_SPLAT1]]
; STRIDED-NEXT:    [[TMP50:%.*]] = getelementptr i32, ptr [[P]], i64 [[TMP49]]
; STRIDED-NEXT:    [[TMP51:%.*]] = trunc i64 [[TMP45]] to i32
; STRIDED-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP50]], i64 [[TMP46]], <vscale x 4 x i1> [[TMP48]], i32 [[TMP51]]), !alias.scope [[META5:![0-9]+]]
...
; STRIDED-NEXT:    [[CURRENT_ITERATION_NEXT]] = add nuw i64 [[TMP44]], [[INDEX]]
...
; STRIDED-UF2-NEXT:    [[TMP35:%.*]] = mul nuw nsw i64 [[INDEX]], [[STRIDE]]
...
; STRIDED-UF2-NEXT:    [[TMP36:%.*]] = getelementptr i32, ptr [[P]], i64 [[TMP35]]
; STRIDED-UF2-NEXT:    [[TMP42:%.*]] = mul i64 [[TMP29]], [[STRIDE]]
; STRIDED-UF2-NEXT:    [[TMP43:%.*]] = getelementptr i32, ptr [[TMP36]], i64 [[TMP42]]
; STRIDED-UF2-NEXT:    [[TMP44:%.*]] = trunc i64 [[TMP29]] to i32
; STRIDED-UF2-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP36]], i64 [[TMP32]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP44]]), !alias.scope [[META8:![0-9]+]]
; STRIDED-UF2-NEXT:    [[TMP45:%.*]] = trunc i64 [[TMP29]] to i32
; STRIDED-UF2-NEXT:    [[WIDE_MASKED_GATHER12:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.strided.load.nxv4i32.p0.i64(ptr align 4 [[TMP43]], i64 [[TMP32]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP45]]), !alias.scope [[META8]]
...
; NOSTRIDED-NEXT:    [[TMP8:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; NOSTRIDED-NEXT:    [[TMP4:%.*]] = icmp ult <vscale x 2 x i32> [[TMP8]], [[BROADCAST_SPLAT]]
; NOSTRIDED-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw i32, ptr [[IN]], i64 [[EVL_BASED_IV]]
; NOSTRIDED-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP1]] to i32
; NOSTRIDED-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.strided.load.nxv2i64.p0.i64(ptr align 8 [[TMP9]], i64 4, <vscale x 2 x i1> [[TMP4]], i32 [[TMP6]])
...
; STRIDED-NEXT:    [[TMP8:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; STRIDED-NEXT:    [[TMP4:%.*]] = icmp ult <vscale x 2 x i32> [[TMP8]], [[BROADCAST_SPLAT]]
; STRIDED-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw i32, ptr [[IN]], i64 [[EVL_BASED_IV]]
; STRIDED-NEXT:    [[TMP6:%.*]] = trunc i64 [[TMP1]] to i32
; STRIDED-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.strided.load.nxv2i64.p0.i64(ptr align 8 [[TMP9]], i64 4, <vscale x 2 x i1> [[TMP4]], i32 [[TMP6]])
...
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <vscale x 4 x ptr> [[TMP3]], i32 0
...
; CHECK-UF2-NEXT:    [[TMP7:%.*]] = extractelement <vscale x 4 x ptr> [[TMP6]], i32 0
; CHECK-UF2-NEXT:    [[TMP8:%.*]] = getelementptr [4 x i32], ptr [[A]], <vscale x 4 x i64> [[STEP_ADD]]
; CHECK-UF2-NEXT:    [[TMP9:%.*]] = extractelement <vscale x 4 x ptr> [[TMP8]], i32 0
...
; CHECK-UF2-NEXT:    br i1 [[TMP20]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; CHECK-UF2:       [[MIDDLE_BLOCK]]:
; CHECK-UF2-NEXT:    [[CMP_N:%.*]] = icmp eq i64 1024, [[N_VEC]]
; CHECK-UF2-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH]]
; CHECK-UF2:       [[SCALAR_PH]]:
...
; CHECK-UF2-NEXT:    br i1 [[DONE]], label %[[EXIT]], label %[[LOOP]], !llvm.loop [[LOOP19:![0-9]+]]
; CHECK-UF2:       [[EXIT]]:
; CHECK-UF2-NEXT:    ret void
;
entry:
