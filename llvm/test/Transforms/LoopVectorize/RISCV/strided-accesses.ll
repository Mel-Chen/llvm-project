...
; CHECK-UF2-NEXT:    [[TMP17:%.*]] = shl i64 [[INDEX]], 5
; CHECK-UF2-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[P]], i64 [[TMP17]]
; CHECK-UF2-NEXT:    [[TMP19:%.*]] = mul i64 [[TMP3]], 32
; CHECK-UF2-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP18]], i64 [[TMP19]]
...
; CHECK-UF2-NEXT:    [[TMP15:%.*]] = shl i64 [[INDEX]], 8
; CHECK-UF2-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr [[P]], i64 [[TMP15]]
; CHECK-UF2-NEXT:    [[TMP17:%.*]] = mul i64 [[TMP3]], 256
; CHECK-UF2-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP17]]
...
; STRIDED-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 4 x i32> @llvm.vp.gather.nxv4i32.nxv4p0(<vscale x 4 x ptr> align 4 [[TMP42]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP43]]), !alias.scope [[META5:![0-9]+]]
...
; NOSTRIDED-UF2:       [[VECTOR_BODY]]:
; NOSTRIDED-UF2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; NOSTRIDED-UF2-NEXT:    [[TMP10:%.*]] = shl nuw i64 [[INDEX]], 2
; NOSTRIDED-UF2-NEXT:    [[TMP5:%.*]] = getelementptr nuw i8, ptr [[IN]], i64 [[TMP10]]
...
; STRIDED-UF2:       [[VECTOR_BODY]]:
; STRIDED-UF2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; STRIDED-UF2-NEXT:    [[TMP10:%.*]] = shl nuw i64 [[INDEX]], 2
; STRIDED-UF2-NEXT:    [[TMP5:%.*]] = getelementptr nuw i8, ptr [[IN]], i64 [[TMP10]]
