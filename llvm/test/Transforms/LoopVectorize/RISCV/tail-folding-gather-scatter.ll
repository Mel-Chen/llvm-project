...
; IF-EVL-NEXT:    [[TMP1:%.*]] = shl i64 [[INDEX1]], 2
; IF-EVL-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[INDEX:%.*]], i64 [[TMP1]]
...
; NO-VP-NEXT:    [[TMP5:%.*]] = shl i64 [[INDVARS_IV1]], 2
; NO-VP-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[INDEX:%.*]], i64 [[TMP5]]
