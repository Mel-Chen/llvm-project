...
; CHECK-NEXT:    [[TMP11:%.*]] = or <vscale x 4 x i1> [[TMP13]], [[BROADCAST_SPLAT1]]
...
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv4i32.nxv4p0(<vscale x 4 x i32> [[PREDPHI]], <vscale x 4 x ptr> align 4 [[BROADCAST_SPLAT4]], <vscale x 4 x i1> [[TMP11]], i32 [[TMP10]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
