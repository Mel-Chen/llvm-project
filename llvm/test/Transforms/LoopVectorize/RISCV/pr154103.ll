...
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[AVL_NEXT:%.*]] = phi i64 [ 1, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[VECTOR_BODY:.*]] ]
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i8, ptr [[A]], i64 [[AVL_NEXT]]
...
; CHECK-NEXT:    [[IV_NEXT]] = add i64 [[AVL_NEXT]], 7
; CHECK-NEXT:    [[TMP16:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
; CHECK-NEXT:    br i1 [[TMP16]], label %[[EXIT:.*]], label %[[VECTOR_PH]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    ret void
;
entry:
