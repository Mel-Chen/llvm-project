...
; RV32-NEXT:    [[TMP26:%.*]] = call <vscale x 2 x i1> @llvm.vp.merge.nxv2i1(<vscale x 2 x i1> splat (i1 true), <vscale x 2 x i1> [[TMP14]], <vscale x 2 x i1> zeroinitializer, i32 [[TMP10]])
...
; RV64-NEXT:    [[TMP12:%.*]] = call <vscale x 2 x i1> @llvm.vp.merge.nxv2i1(<vscale x 2 x i1> splat (i1 true), <vscale x 2 x i1> [[TMP14]], <vscale x 2 x i1> zeroinitializer, i32 [[TMP10]])
