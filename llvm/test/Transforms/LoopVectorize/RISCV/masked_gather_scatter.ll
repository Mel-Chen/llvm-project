...
; RV32-NEXT:    [[TMP6:%.*]] = shl i32 [[TMP12]], 6
; RV32-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[TRIGGER]], i32 [[TMP6]]
...
; RV64-NEXT:    [[TMP5:%.*]] = shl i64 [[INDEX]], 6
; RV64-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[TRIGGER]], i64 [[TMP5]]
