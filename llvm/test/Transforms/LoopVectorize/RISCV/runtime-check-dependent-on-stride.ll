...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP19:%.*]] = call i64 @llvm.vscale.i64()
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP27:%.*]] = shl nuw i64 [[TMP19]], 1
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP33:%.*]] = shl i64 [[STRIDE]], 3
...
; NO-UNIT-STRIDE-MV-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 2 x i32> poison, i32 [[TMP25]], i64 0
; NO-UNIT-STRIDE-MV-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 2 x i32> [[BROADCAST_SPLATINSERT]], <vscale x 2 x i32> poison, <vscale x 2 x i32> zeroinitializer
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP34:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP24:%.*]] = icmp ult <vscale x 2 x i32> [[TMP34]], [[BROADCAST_SPLAT]]
; NO-UNIT-STRIDE-MV-NEXT:    [[OFFSET_IDX:%.*]] = add i64 1, [[INDEX]]
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP35:%.*]] = mul i64 [[OFFSET_IDX]], [[STRIDE]]
...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP28:%.*]] = getelementptr i64, ptr [[P_STRIDED]], i64 [[TMP35]]
...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP29:%.*]] = trunc i64 [[TMP27]] to i32
; NO-UNIT-STRIDE-MV-NEXT:    [[WIDE_MASKED_GATHER22:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.strided.load.nxv2i64.p0.i64(ptr align 8 [[TMP28]], i64 [[TMP33]], <vscale x 2 x i1> [[TMP24]], i32 [[TMP29]]), !alias.scope [[META3:![0-9]+]]
