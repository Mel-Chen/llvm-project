...
; CHECK-NEXT:    [[TMP14:%.*]] = xor <vscale x 2 x i1> [[TMP12]], splat (i1 true)
; CHECK-NEXT:    [[TMP15:%.*]] = or <vscale x 2 x i1> [[TMP12]], [[TMP14]]
...
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv2i8.nxv2p0(<vscale x 2 x i8> [[TMP17]], <vscale x 2 x ptr> align 1 [[BROADCAST_SPLAT4]], <vscale x 2 x i1> [[TMP15]], i32 [[TMP11]])
