...
; CHECK-NEXT:    [[TMP14:%.*]] = shl i64 [[TMP13]], 4
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr [[P1]], i64 [[TMP14]]
; CHECK-NEXT:    [[TMP15:%.*]] = call <vscale x 2 x i32> @llvm.experimental.vp.strided.load.nxv2i32.p0.i64(ptr align 4 [[TMP22]], i64 16, <vscale x 2 x i1> splat (i1 true), i32 [[TMP9]])
