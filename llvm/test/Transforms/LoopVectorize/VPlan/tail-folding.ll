...
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP8:%[0-9]+]]> = phi [ vp<[[VP11:%[0-9]+]]>, vector.body.split ], [ ir<poison>, vector.body ]
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP9:%[0-9]+]]> = phi [ ir<%y>, vector.body.split ], [ ir<poison>, vector.body ]
...
; CHECK-NEXT:    EMIT vp<[[VP11]]> = exiting-iv-value ir<%iv>
; CHECK-NEXT:    EMIT vp<[[VP12:%[0-9]+]]> = extract-last-part vp<[[VP8]]>
; CHECK-NEXT:    EMIT vp<[[VP13:%[0-9]+]]> = extract-last-lane vp<[[VP12]]>
; CHECK-NEXT:    EMIT vp<[[VP14:%[0-9]+]]> = extract-last-part vp<[[VP9]]>
; CHECK-NEXT:    EMIT vp<[[VP15:%[0-9]+]]> = extract-last-lane vp<[[VP14]]>
; CHECK-NEXT:    EMIT vp<[[VP16:%[0-9]+]]> = last-active-lane vp<[[VP6]]>
; CHECK-NEXT:    EMIT vp<[[VP17:%[0-9]+]]> = extract-lane vp<[[VP16]]>, vp<[[VP8]]>
; CHECK-NEXT:    EMIT vp<[[VP18:%[0-9]+]]> = last-active-lane vp<[[VP6]]>
; CHECK-NEXT:    EMIT vp<[[VP19:%[0-9]+]]> = extract-lane vp<[[VP18]]>, vp<[[VP9]]>
; CHECK-NEXT:    EMIT branch-on-cond ir<true>
; CHECK-NEXT:  Successor(s): ir-bb<exit>, scalar.ph
; CHECK-EMPTY:
; CHECK-NEXT:  ir-bb<exit>:
; CHECK-NEXT:    IR   %y.lcssa = phi i32 [ %y, %loop ] (extra operand: vp<[[VP19]]> from middle.block)
; CHECK-NEXT:  No successors
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    EMIT-SCALAR vp<%bc.resume.val> = phi [ vp<[[VP11]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
...
; CHECK-EMPTY:
; CHECK-NEXT:    vector.latch:
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP8:%[0-9]+]]> = phi [ vp<[[VP11:%[0-9]+]]>, latch ], [ ir<poison>, vector.body ]
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP9:%[0-9]+]]> = phi [ ir<%phi>, latch ], [ ir<poison>, vector.body ]
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP4]]>, vp<[[VP1]]>
; CHECK-NEXT:      EMIT branch-on-count vp<%index.next>, vp<[[VP2]]>
; CHECK-NEXT:    No successors
; CHECK-NEXT:  }
...
; CHECK-EMPTY:
; CHECK-NEXT:  ir-bb<exit>:
; CHECK-NEXT:    IR   %phi.lcssa = phi i32 [ %phi, %latch ] (extra operand: vp<[[VP19]]> from middle.block)
; CHECK-NEXT:  No successors
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    EMIT-SCALAR vp<%bc.resume.val> = phi [ vp<[[VP11]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
...
; CHECK-EMPTY:
; CHECK-NEXT:    vector.latch:
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP8:%[0-9]+]]> = phi [ vp<[[VP10:%[0-9]+]]>, latch ], [ ir<poison>, vector.body ]
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP4]]>, vp<[[VP1]]>
; CHECK-NEXT:      EMIT branch-on-count vp<%index.next>, vp<[[VP2]]>
; CHECK-NEXT:    No successors
; CHECK-NEXT:  }
...
; CHECK-EMPTY:
; CHECK-NEXT:  middle.block:
; CHECK-NEXT:    EMIT vp<[[VP10]]> = exiting-iv-value ir<%iv>
...
; CHECK-NEXT:      EMIT-SCALAR vp<[[VP9:%[0-9]+]]> = phi [ vp<[[VP11:%[0-9]+]]>, vector.body.split ], [ ir<poison>, vector.body ]
; CHECK-NEXT:      EMIT vp<%index.next> = add nuw vp<[[VP4]]>, vp<[[VP1]]>
; CHECK-NEXT:      EMIT branch-on-count vp<%index.next>, vp<[[VP2]]>
; CHECK-NEXT:    No successors
; CHECK-NEXT:  }
...
; CHECK-NEXT:  middle.block:
; CHECK-NEXT:    EMIT vp<[[VP11]]> = exiting-iv-value ir<%iv>
; CHECK-NEXT:    EMIT vp<[[VP12:%[0-9]+]]> = extract-last-part vp<[[VP9]]>
; CHECK-NEXT:    EMIT vp<[[VP13:%[0-9]+]]> = extract-last-lane vp<[[VP12]]>
; CHECK-NEXT:    EMIT vp<[[VP14:%[0-9]+]]> = extract-last-part vp<[[VP8]]>
; CHECK-NEXT:    EMIT vp<[[VP15:%[0-9]+]]> = extract-last-lane vp<[[VP14]]>
; CHECK-NEXT:    EMIT vp<[[VP16:%[0-9]+]]> = extract-last-part vp<[[VP8]]>
; CHECK-NEXT:    EMIT vp<[[VP17:%[0-9]+]]> = extract-last-lane vp<[[VP16]]>
; CHECK-NEXT:    EMIT vp<[[VP18:%[0-9]+]]> = last-active-lane vp<[[VP6]]>
; CHECK-NEXT:    EMIT vp<[[VP19:%[0-9]+]]> = extract-lane vp<[[VP18]]>, vp<[[VP9]]>
; CHECK-NEXT:    EMIT vp<[[VP20:%[0-9]+]]> = last-active-lane vp<[[VP6]]>
; CHECK-NEXT:    EMIT vp<[[VP21:%[0-9]+]]> = extract-lane vp<[[VP20]]>, vp<[[VP8]]>
; CHECK-NEXT:    EMIT vp<[[VP22:%[0-9]+]]> = last-active-lane vp<[[VP6]]>
; CHECK-NEXT:    EMIT vp<[[VP23:%[0-9]+]]> = extract-lane vp<[[VP22]]>, vp<[[VP8]]>
; CHECK-NEXT:    EMIT branch-on-cond ir<true>
; CHECK-NEXT:  Successor(s): ir-bb<exit>, scalar.ph
; CHECK-EMPTY:
; CHECK-NEXT:  ir-bb<exit>:
; CHECK-NEXT:    IR   %rdx.next.lcssa = phi i32 [ %rdx.next, %loop ] (extra operand: vp<[[VP23]]> from middle.block)
; CHECK-NEXT:  No successors
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    EMIT-SCALAR vp<%bc.resume.val> = phi [ vp<[[VP11]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
; CHECK-NEXT:    EMIT-SCALAR vp<%bc.merge.rdx> = phi [ vp<[[VP21]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
; CHECK-NEXT:  Successor(s): ir-bb<loop>
; CHECK-EMPTY:
; CHECK-NEXT:  ir-bb<loop>:
; CHECK-NEXT:    IR   %iv = phi i32 [ 0, %entry ], [ %iv.next, %loop ] (extra operand: vp<%bc.resume.val> from scalar.ph)
