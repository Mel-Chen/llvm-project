...
public:
  ...
  static inline bool classof(const VPRecipeBase *R) {
    ...
    case VPRecipeBase::VPStridedLoadSC:
...
public:
  ...
  static inline bool classof(const VPRecipeBase *R) {
    return R->getVPDefID() == VPRecipeBase::VPWidenLoadSC ||
           ...
           R->getVPDefID() == VPRecipeBase::VPStridedLoadSC;
  }
...
/// optional mask.
struct VPStridedLoadRecipe final : public VPWidenMemoryRecipe, public VPValue {
  VPStridedLoadRecipe(LoadInst &Load, VPValue *Addr, VPValue *Stride,
                      VPValue *VF, VPValue *Mask, DebugLoc DL)
      : VPWidenMemoryRecipe(VPDef::VPStridedLoadSC, Load, {Addr, Stride, VF},
                            /*Consecutive=*/false, /*Reverse=*/false, DL),
        VPValue(this, &Load) {
    setMask(Mask);
  }

  VPStridedLoadRecipe *clone() override {
    return new VPStridedLoadRecipe(cast<LoadInst>(Ingredient), getAddr(),
                                   getStride(), getVF(), getMask(),
                                   getDebugLoc());
  }

  VP_CLASSOF_IMPL(VPDef::VPStridedLoadSC);
  ...
  /// Return the cost of this VPStridedLoadRecipe.
  InstructionCost computeCost(ElementCount VF,
                              VPCostContext &Ctx) const override;
